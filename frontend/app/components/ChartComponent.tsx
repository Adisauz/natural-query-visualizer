...
export default function ChartComponent({ data, narrative }: ChartComponentProps) {
  ...
  // If we have multiple charts, render them vertically with narrative
      ...
      <div className="space-y-8">
        ...
        {narrative?.introduction && (
          <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 rounded-lg p-6 border border-blue-700/50">
            <h2 className="text-lg font-semibold text-blue-300 mb-3">Overview</h2>
        ...
        <div className="space-y-8">
          {chartsData.map((chartData, index) => (
            <div key={index}>
              ...
              {/* Transition text (between charts) */}
              {narrative?.transitions && narrative.transitions[index] && (
                  <div className="my-6 bg-gradient-to-r from-green-900/20 to-teal-900/20 rounded-lg p-4 border border-green-700/30">
                    <p className="text-gray-300 leading-relaxed italic">{narrative.transitions[index]}</p>
                </div>
              )}
            </div>
          ))}
        ...
        {narrative?.insights && narrative.insights.length > 0 && (
          <div className="bg-gradient-to-r from-yellow-900/20 to-orange-900/20 rounded-lg p-6 border border-yellow-700/30">
            <h2 className="text-lg font-semibold text-yellow-300 mb-4">Key Insights</h2>
        ...
        {narrative?.conclusion && (
          <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 rounded-lg p-6 border border-purple-700/50">
            <h2 className="text-lg font-semibold text-purple-300 mb-3">Conclusion</h2>
